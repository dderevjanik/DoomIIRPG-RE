...
static bool writeResourceFiles(const std::string& outDir) {
    ...
    for (size_t i = 0; i < EMBEDDED_RESOURCES_COUNT; i++) {
        ...
        // Ensure parent directory exists (for nested paths like levels/*/level.yaml)
...
int main(int argc, char* argv[]) {
	...
	// Phase 1: Write resource YAML files and extract strings
