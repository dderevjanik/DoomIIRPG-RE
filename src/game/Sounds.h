...
class Sounds {
  public:
	...
	// Hardcoded fallback table (original 144 sounds)
	static constexpr const char* DEFAULT_FILE_NAMES[] = {"Arachnotron_active.wav", // 0
	...
	static constexpr int DEFAULT_COUNT = 144;
};
