...
public:
	...
	int getMonsterField(EntityDef* entityDef, int fieldIdx);
	void checkForBFGDeaths(int x, int y);
	void radiusHurtEntities(int centerTileX, int centerTileY, int knockback, int damage, Entity* entity, Entity* entity2);
	void hurtEntityAt(int tileX, int tileY, int centerTileX, int centerTileY, int knockback, int damage, Entity* entity, Entity* entity2);
	void hurtEntityAt(int tileX, int tileY, int centerTileX, int centerTileY, int knockback, int damage, Entity* entity, bool gibCorpses, Entity* entity2);
	Text* getWeaponStatStr(int weaponIdx);
	Text* getArmorStatStr(int armorIdx);
	int WorldDistToTileDist(int worldDist);
	void cleanUpAttack();
	void updateProjectile();
	void launchProjectile();
	GameSprite* allocMissile(int x1, int y1, int z1, int x2, int y2, int z2, int duration, int renderMode);
	void launchSoulCube();
	int getWeaponTileNum(int weaponIdx);
