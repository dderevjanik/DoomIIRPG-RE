...
public:
	...
	int TILE_BOSS_VIOS5;
	int TILE_OBJ_CRATE;
	int TILE_TERMINAL_TARGET;
	int TILE_TERMINAL_HACKING;
	int TILE_CLOSED_PORTAL_EYE;
	int TILE_EYE_PORTAL;
	int TILE_PORTAL_SOCKET;
	int TILE_RED_DOOR_LOCKED;
	int TILE_BLUE_DOOR_UNLOCKED;
	int TILE_FLAT_LAVA;
	int TILE_FLAT_LAVA2;
	int TILE_HELL_HANDS;
	int TILE_FADE;
	int TILE_SCORCH_MARK;
	int TILE_WATER_STREAM;
	int TILE_OBJ_FIRE;
	int TILE_OBJ_TORCHIERE;
	int TILE_SFX_LIGHTGLOW1;
	int TILE_WATER_SPOUT;
	int TILE_TREE_TOP;
	int TILE_TREE_TRUNK;
	int TILE_PRACTICE_TARGET;
	int TILE_OBJ_CORPSE;
	int TILE_OBJ_OTHER_CORPSE;
	int TILE_OBJ_SCIENTIST_CORPSE;
	int TILE_MONSTER_SENTRY_BOT;
	int TILE_MONSTER_RED_SENTRY_BOT;
	int TILE_TREADMILL_SIDE;
	int TILE_SENTINEL_SPIKES_DUMMY;
	int TILE_SHADOW;
	int TILE_GLASS;
